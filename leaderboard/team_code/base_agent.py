...
WEATHERS = {
    "ClearMorning": carla.WeatherParameters(5.0, 0.0, 0.0, 0.35, 45.0, 35.0, 0.0, 0.0, 0.0, 0.0),
    "ClearDawn": carla.WeatherParameters(5.0, 0.0, 0.0, 0.35, 45.0, 5.0, 0.0, 0.0, 0.0, 0.0),
    ...
    "CloudyNight": carla.WeatherParameters(60.0, 0.0, 30.0, 10.0, -1.0, -90.0, 60.0, 0.75, 0.1, 0.0),
    "HardRainMorning": carla.WeatherParameters(100.0, 100.0, 70.0, 50.0, 45.0, 25.0, 0.0, 0.0, 0.0, 0.0),
    "HardRainDawn": carla.WeatherParameters(100.0, 100.0, 70.0, 50.0, 45.0, 3.0, 0.0, 0.0, 0.0, 0.0),
...
class BaseAgent(autonomous_agent.AutonomousAgent):
    ...
    def save(
        ...
        data = {
            ...
            "command": near_command.value, # near command
            "gt_command": self._command_planner.route[0][1].value, #far command
            "steer": steer,
            "throttle": throttle,
            "brake": brake,
            "reward": reward,
