...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan  4 16:12:46 2024
...
class HiPrompt(nn.Module):
    def __init__(self, emb_d, n_tasks, prompt_param, key_dim=768, device='cuda:0'):
        ...
        for e in self.e_layers:
            ...
            local_k = tensor_prompt(self.e_pool_size, self.key_d, device=device)
            global_k = tensor_prompt(self.n_tasks, self.key_d, device=device)
    ...
    def forward(self, x_querry, l, x_block=None, train=False, task_id=None):
        ...
        if l in self.e_layers:
            ...
            if train:
                ...
                loss = self.ortho_penalty(global_key) # + self.prompt_loss(global_attention, target_domain) * 5
