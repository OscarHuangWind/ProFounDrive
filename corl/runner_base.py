...
class RunnerBase:
    ...
    def __init__(self, cfg, task, model, datasets, job_id):
        ...
        # wandb init
        if is_main_process():
            wandb_cfg = self.config.run_cfg.wandb_cfg
            dont_log_wandb = wandb_cfg.dont_log_wandb
            wandb_mode = "online" if not dont_log_wandb else "disabled"

            wandb.login("6d8055b6788d464df61a17888ea037bd30def315")

            wandb.init(
            project = 'MobileVLM_Drive',
    ...
    def optimizer(self):
        ...
        if self._optimizer is None:
            ...
            logging.info("number of total parameters: {}".format(total_params))
                ...
                for split_name in self.valid_splits:
                    ...
                    if val_log is not None:
                        if is_main_process():
                            ...
                            wandb.log({'eval_agg_metric': agg_metrics})
    ...
    @main_process
    def _save_checkpoint(self, cur_epoch, is_best=False, cur_iter=None):
        """
    ...
    def _load_checkpoint(self, url_or_filename):
        ...
        try:
            ...
            print('failed loading optimizer')
        ...
        if 'iter' in checkpoint.keys():
            self.start_iters = checkpoint['iter'] + 1
