...
def main():
    ...
    parser.add_argument('--trafficManagerSeed', default='3', #3407, 42, 525
                        help='Seed used by the TrafficManager (default: 0)')
    parser.add_argument('--carlaProviderSeed', default='3', #3407, 42, 525
    ...
    parser.add_argument('--scenarios',
                        ...
                        default='/home/oscar/Dropbox/VisionFoundationVehicle/leaderboard/data/scenarios/town05_all_scenarios.json')
    ...
    parser.add_argument("--checkpoint", type=str,
                        default='/home/oscar/Dropbox/VisionFoundationVehicle/results/corl_result_town05_2024941462_profoundrive_mobilevla_benchmark_seed3.json',
