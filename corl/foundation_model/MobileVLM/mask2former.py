...
class SegEncoder():
    def __init__(self, device):
        ...
        # self.feature_extractor = AutoImageProcessor.from_pretrained("/home/oscar/.cache/huggingface/hub/models--facebook--mask2former-swin-large-mapillary-vistas-semantic/snapshots/4772b6bf101d91f2534c106dc524d906aeb3c68a")
        ...
        # self.feature_extractor = AutoImageProcessor.from_pretrained(r"C:\Users\oscar\.cache\huggingface\hub\models--facebook--mask2former-swin-large-mapillary-vistas-semantic\snapshots\4772b6bf101d91f2534c106dc524d906aeb3c68a")
        # self.model = Mask2FormerForUniversalSegmentation.from_pretrained("facebook/mask2former-swin-large-mapillary-vistas-semantic").cuda()
    ...
    def forward(self, image):
        ...
        segmentation_image = cv2.resize(segmentation_overlay, tuple((image.shape[0], image.shape[1])))
        torch.cuda.empty_cache()
